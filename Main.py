...
cookies = [{'domain': 'vle.mathswatch.co.uk', 'expiry': 1682966553, 'httpOnly': False, 'name': '_csrf', 'path': '/', 'sameSite': 'Lax', 'secure': False, 'value': 'kDBvmE63-tzqjopoVSKXk_vf4dn8dmeAfohY'}, {'domain': '.mathswatch.co.uk', 'expiry': 1682959412, 'httpOnly': False, 'name': '_gat', 'path': '/', 'sameSite': 'Lax', 'secure': False, 'value': '1'}, {'domain': '.mathswatch.co.uk', 'expiry': 1683045743, 'httpOnly': False, 'name': '_gid', 'path': '/', 'sameSite': 'Lax', 'secure': False, 'value': 'GA1.3.485344912.1682959344'}, {'domain': '.mathswatch.co.uk', 'expiry': 1717519343, 'httpOnly': False, 'name': '_ga', 'path': '/', 'sameSite': 'Lax', 'secure': False, 'value': 'GA1.3.103047820.1682959344'}, {'domain': 'vle.mathswatch.co.uk', 'expiry': 1682962953, 'httpOnly': True, 'name': 'connect.sid', 'path': '/', 'sameSite': 'Lax', 'secure': False, 'value': 's%3AdF-heaO8m1HCbaECyKlTdvIHWZ2XhXFI.f%2FD5mfJ4ij8S2jCGYWMchvfCOOdWXuB5lWVleoPYu94'}]   
for cookie in cookies:
    driver.add_cookie(cookie)
#The current set of questions being worked on is 50
i=50
...
def OrderDec():
    ...
    try:
        water = driver.find_element(by=By.XPATH, value='/html/body/app/main/div[2]/routehandler/div/div[1]/div/panel/div/div[4]/div/div[2]/answer/div/formhorizontal/form/div/div/subtag/div/formgroup/div/div/div/div/div[1]')
        actions.send_keys_to_element(water, "7.83").perform()
        water = driver.find_element(by=By.XPATH, value='/html/body/app/main/div[2]/routehandler/div/div[1]/div/panel/div/div[4]/div/div[2]/answer/div/div/div/button')
        actions.click(water).perform()
        water = driver.find_element(by=By.XPATH, value='/html/body/app/toaster/div/a')
        actions.click(water).perform()
